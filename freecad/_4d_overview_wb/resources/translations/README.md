# About translating _4d_overview_wb Workbench

> [!NOTE]
> All commands **must** be run in `./freecad/_4d_overview_wb/resources/translations/` directory.
...
at <https://crowdin.com/project/freecad-addons> webpage and find the **_4d_overview_wb** project.

## Creating file for missing locale

### Using script

To create a file for a new language with all **_4d_overview_wb** translatable strings execute
...
Also you can rename new `_4d_overview_wb.ts` file by appending the locale code,
...
once done, look for the **_4d_overview_wb** project.
...
Now you can contribute your translated `.ts` file to **_4d_overview_wb** repository,
